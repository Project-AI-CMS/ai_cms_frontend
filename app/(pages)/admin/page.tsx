  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 cursor-pointer hover:shadow-md transition">
          <h2 className="text-2xl font-bold text-blue-900">Users</h2>
          <p className="text-blue-700 text-sm mt-1">Manage system users</p>
        </div>
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 cursor-pointer hover:shadow-md transition">
          <h2 className="text-2xl font-bold text-purple-900">Roles</h2>
          <p className="text-purple-700 text-sm mt-1">Manage system roles</p>
        </div>
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 cursor-pointer hover:shadow-md transition">
